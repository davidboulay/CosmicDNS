...
REPO="davidboulay/CosmicDNS"
APP_ID="com.github.davidboulay.CosmicAppletDNS"
BIN="cosmic-applet-dns"
...
msg "Installing CosmicDNS to $PREFIX"
...
✅ CosmicDNS installed to $BIN_DIR/$BIN
